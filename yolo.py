...
labelsPath = 'S:\Smit_Academics\YOLO\yolo-coco\coco.names'
...
weightsPath = 'S:\Smit_Academics\YOLO\yolo-coco\yolov3.weights'
configPath = 'S:\Smit_Academics\YOLO\yolo-coco\yolov3.cfg'

# load our YOLO object detector trained on COCO dataset (80 classes)
net = cv2.dnn.readNetFromDarknet(configPath, weightsPath)
def get_detected(image):
